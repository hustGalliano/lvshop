...
public class UserController {
	...
	public Response saveUserInfo(User user) {
		LOGGER.info("=====日志=====: 接收到新增用户信息的请求，用户id="
				+ user.getUserId() + ", 用户姓名=" + user.getName() + ", 用户年龄=" + user.getAge());
	...
	public Response removeUserInfo(Long userId) {
		LOGGER.info("=====日志=====: 接收到删除用户信息的请求，用户id=" + userId);
	...
	public Response updateUserInfo(User user) {
		LOGGER.info("=====日志=====: 接收到更新用户信息的请求，用户id="
				+ user.getUserId() + ", 用户姓名=" + user.getName() + ", 用户年龄=" + user.getAge());
