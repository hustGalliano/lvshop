...
public class ProductInventoryServiceImpl implements ProductInventoryService {
	...
	public void saveProductInventory(ProductInventory productInventory) {
		...
		LOGGER.info("=====日志=====: 已在数据库新增商品库存，商品id=" + productInventory.getProductId()
	...
	public void updateProductInventory(ProductInventory productInventory) {
		...
		LOGGER.info("=====日志=====: 已修改数据库中的库存，商品id=" + productInventory.getProductId()
				+ ", 商品库存数量=" + productInventory.getInventoryCnt());
	}
	...
	public void setProductInventoryCache(ProductInventory productInventory) {
		...
		LOGGER.info("=====日志=====: 已更新商品库存的缓存，商品id=" + productInventory.getProductId()
